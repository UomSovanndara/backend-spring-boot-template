...
public class CollectionUtils {
    public static void main(String[] args) {
        ...
        names = names.stream().sorted((a,b) -> b.compareTo(a)).collect(Collectors.toList());
        disply(names);
        ...
        System.out.println("===============random, limit, forEach===============");
    ...
    public static void disply (List<String> items) {
    ...
    public static List<String> sortWithJava8(List<String> items) {
        // Collections.sort(items, (String a, String b) -> { return b.compareTo(a);});
        // Collections.sort(names, (String a, String b) -> b.compareTo(a));
        // Collections.sort(names, (a, b) -> b.compareTo(a));
        items.stream().sorted((a,b) -> b.compareTo(a)).collect(Collectors.toList());
        return items;
    }
    
    public static List<String>  filterJava8 (List<String> items) {
       return items.stream().filter(string -> !string.isEmpty()).collect(Collectors.toList());
    }
    ...
    public static void testPeriod(){
     ...
     public static void testAdjusters(){
         ...
         // For example, get the "Second Saturday of the Month" or 
         // "Next Tuesday". Let us see an example of it −
     ...
     public static void testBackwardCompatability(){
          ...
          * Use an ofInstant(Insant,ZoneId) method to get a LocalDateTime 
          * or ZonedDateTime object. Let us understand it with an example −
          */
